// @ts-nocheck
/**
 * Bill Analyzer Edge Function v5
 */
...
function selectBestOffers(offerte, consumo, costoAttuale, soglia, tipo) {
  ...
  const valutate = offerte
    ...
    .filter(x => x.risparmio !== null && x.risparmio / 12 >= soglia)
        ...
        if (mesi > 0) {
          ...
          if (consumo > 0) {
            ...
            if (offertaFissa.id || offertaVariabile.id) {
              ...
              luce.messaggio_utente = "La tua tariffa attuale è già tra le migliori sul mercato.";
            }
        ...
        if (mesi > 0) {
          ...
          if (consumo > 0) {
            ...
            if (offertaFissa.id || offertaVariabile.id) {
              ...
              gas.messaggio_utente = "La tua tariffa gas attuale è già competitiva.";
            }
          }
        }
      }
