             ...
             <CardContent className="p-0">
                <div className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="text-center md:text-left space-y-2">
                        <h4 className="font-bold text-purple-900 text-2xl">💰 Offerta più economica: {bestOfferName}</h4>
                        ...
                        <p className="text-sm text-purple-600/80 max-w-md">
                            La soluzione più conveniente sul mercato oggi. Consulta l'analisi AI per valutare se è adatta al tuo profilo di rischio.
                        </p>
                    </div>
