      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full border-collapse">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            <tr className="bg-gray-50/30"><td className="py-3 px-4 font-medium text-sm text-gray-700">Prezzo Energia</td><td className="py-3 px-4 text-center text-sm">N/D</td>{effectiveFixedOffer && <td className="py-3 px-4 text-center bg-blue-50/30 text-sm text-blue-700">{effectiveFixedOffer.priceKwh ? `€ ${effectiveFixedOffer.priceKwh.toFixed(3)}/kWh` : 'N/D'}</td>}{variableOffer && <td className="py-3 px-4 text-center bg-green-50/30 text-sm text-green-700">{variableOffer.priceKwh ? `€ ${variableOffer.priceKwh.toFixed(3)}/kWh` : 'N/D'}</td>}</tr>
            <tr className="bg-gray-50/30"><td className="py-3 px-4 font-medium text-sm text-gray-700">Quota Fissa</td><td className="py-3 px-4 text-center text-sm">N/D</td>{effectiveFixedOffer && <td className="py-3 px-4 text-center bg-blue-50/30 text-sm text-blue-700">{effectiveFixedOffer.fixedMonthly ? `€ ${effectiveFixedOffer.fixedMonthly.toFixed(2)}/mese` : 'N/D'}</td>}{variableOffer && <td className="py-3 px-4 text-center bg-green-50/30 text-sm text-green-700">{variableOffer.fixedMonthly ? `€ ${variableOffer.fixedMonthly.toFixed(2)}/mese` : 'N/D'}</td>}</tr>
